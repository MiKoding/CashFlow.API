...
namespace WebApi.IntegrationTest.Users.ChangePassword;
public class ChangePasswordTest : CashFlowClassFixture
{
    ...
    public async Task Error_Password_Different_Current_Password(string culture)
    {
        ...
        var expectedMessage = ResourceErrorMessages.ResourceManager.GetString(ResourceErrorMessages.PASSWORD_DIFFERENT_CURRENT_PASSWORD, new System.Globalization.CultureInfo(culture));
